...
<form action="<?php echo e(URL::to('multi/route/plan/store')); ?>" method="post" >
  <?php echo csrf_field(); ?>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <input id="form_name" type="number" name="quantity[]" class="form-control" style="margin-top: 2%;" placeholder="Product Quantity" required="required">
                <div id="fieldList1">
            ...
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input id="form_lastname" type="number" name="amount[]" class="form-control mt-1" style="margin-top: 2%;" placeholder="Price Per Item" required="required" data-error="Amount is required.">
                <div id="fieldList2">
            ...
            <div class="col-md-4">
              <div class="form-group">
                <label for="form_lastname">F.O.C</label>
                <input id="form_lastname" type="number" name="foc[]" class="form-control mt-1" style="margin-top: 2%;" placeholder="Price Per Item" required="required" value="0">
                <div id="fieldList3">
            ...
            <div class="col-md-12">  <button id="addMore" class="btn btn-warning  btn-sm">Add</button></div>
...
<script type="text/javascript">
  ...
  $("#addMore").click(function(e) {
    e.preventDefault();
    $("#fieldList1").append("<input id='form_name' type='number' name='quantity[]' class='form-control' style='margin-top: 2%;' value='0'>");
  });
});
...
<script type="text/javascript">
  ...
  $("#addMore").click(function(e) {
    e.preventDefault();
    $("#fieldList2").append("<input id='form_name' type='number' name='amount[]' class='form-control' style='margin-top: 2%;' value='0'>");
  });
});
...
<script type="text/javascript">
  ...
  $("#addMore").click(function(e) {
    e.preventDefault();
    $("#fieldList3").append("<input id='form_lastname' type='number' name='foc[]' class='form-control mt-1' style='margin-top: 2%;'  required='required' data-error='Amount is required.' value='0'>");
  });
});
...
<?php echo $__env->make("layouts.tables", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thiri/yoonhanthar/intime-delivery/resources/views/route/multi_create.blade.php ENDPATH**/ ?>