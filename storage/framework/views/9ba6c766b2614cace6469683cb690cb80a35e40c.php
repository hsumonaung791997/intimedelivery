				...
				<div class="panel-body">
					<table class="table">
						...
						<tbody id="tbody">
							...
							<tr>
								<td>
									<?php echo e($row->account_head_account_id); ?>
							...
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
							 <tr>
							 	...
							 	<td><?php echo e($result->sum('cr_amount')); ?></td>
							 	<td><?php echo e($result->sum('dr_amount')); ?></td>
							 	<td></td>
							 	<td></td>
							 </tr>						
						</tbody>
...
<?php echo $__env->make("layouts.admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intime_delivery\resources\views/admin/account-head-ledger/search.blade.php ENDPATH**/ ?>