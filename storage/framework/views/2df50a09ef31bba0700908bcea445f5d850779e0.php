												...
												<td>
   													<div class="dropdown">
  														...
  														<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
  															...
  															<div class="text-center"><a href="<?php echo e(URL::to('admin/route/print/'.$row->p_id.'/'.$row->rp_id)); ?>" >Print</a></div>
    														<?php if($row->status==1 || $row->status==2): ?>
  															<?php else: ?>
  																<div class="text-center"><a class="dropdown-item" href="<?php echo e(URL::to('admin/order/verify/'.$row->o_id)); ?>">Verify</a></div>
...
<?php echo $__env->make("layouts.admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intime_delivery\resources\views/admin/order/order_list.blade.php ENDPATH**/ ?>