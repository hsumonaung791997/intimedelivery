			...
			<div class="col-md-12">
							...
							<div class="panel">
								...
								<div class="panel-body">
									<div class="row">
										<form action="<?php echo e(URL::to('admin/stock/list/search')); ?>" method="get">
										<?php echo csrf_field(); ?> 
										<?php 
									...
									<?php if(isset($result_data)): ?>
									 <?php echo e($result_data->appends(Request::except('/admin/stock/list/search'))->setPath('/admin/stock/list/search')); ?>


									<?php else: ?>
									 <?php echo e($result->appends(Request::except('/admin/stock/list'))->setPath('/admin/stock/list')); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thiri/yoonhanthar/intime-delivery/resources/views/admin/stock/stock_list.blade.php ENDPATH**/ ?>