...
<div class="col-md-12">
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Parcel FOC List</h3>
                                </div>
                                <div class="panel-body">
                                    <form action="<?php echo e(URL::to('admin/foc/search')); ?>" method="get">
                  ...
                  <div class="col-md-3 col-lg-3 col-sm-3">
                   ...
                   <input name="print" type="submit" class="btn btn-success" value="Print"> 
                                    ...
                                    <table class="table">
                                     ...
                                     <?php if(isset($result_data)): ?>
                  <?php echo e($result_data->appends(Request::except('/admin/foc/search'))->setPath('/admin/foc/search')); ?>

                  <?php else: ?>
                  <?php echo e($result->appends(Request::except('/admin/foc/list'))->setPath('/admin/foc/list')); ?>
...
<?php echo $__env->make("layouts.admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/thiri/yoonhanthar/intime-delivery/resources/views/admin/online_shop/foc.blade.php ENDPATH**/ ?>