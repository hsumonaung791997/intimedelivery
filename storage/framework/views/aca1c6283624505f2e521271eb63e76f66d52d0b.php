    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <form method="POST" action="<?php echo e(route('admin.login.submit')); ?>" class="login100-form validate-form">
                    <?php echo csrf_field(); ?>
...
if (isset($messageCache)) { $message = $messageCache; }
                    ...
                    <div class="text-center p-t-115">
                        ...
                        <a class="txt2" href="<?php echo e(URL::to('login')); ?>">
                            Login As User
                        </a>
                    </div>
                </form>
...
</html><?php /**PATH /home/thiri/yoonhanthar/intime-delivery/resources/views/auth/admin-login.blade.php ENDPATH**/ ?>