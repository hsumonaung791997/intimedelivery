...
<?php if(isset($o_table)): ?>
<?php $__currentLoopData = $o_table; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <link rel="stylesheet" href="<?php echo e(URL::to('bootstrap-select.css')); ?>">
    ...
    <label>Order ID : </label>
      <div class="form-group mx-sm-3 mb-2">
        <input type="hidden" name="primary_id" value="<?php echo e($table->id); ?>">
        <input type="text" class="form-control" name="order_id" readonly="readonly" value="<?php echo e($table->o_id); ?>" >
    ...
    <label>Order Date : </label>
      <div class="form-group mx-sm-3 mb-2">
         ...
         <input type="date" name="order_date" class="form-control" value="<?php echo  $dates=$table->o_register_date;?>" required>
      </div>
  </div>
   <div class="form-inline col-12" style="margin-top: 1%;">
    <label>Description : </label>
      <div class="form-group mx-sm-3 mb-2">
        ...
        <textarea class="form-control" name="description"  rows="1" cols="120" required><?php echo e($table->o_description); ?></textarea>

      </div>
      <div class="pull-right">
        <input type="submit" name="adds" class="btn btn-primary btn-sm" value="Add">
      </div>
  </div>
  <!-- Start Body -->
   <div style="margin-top: 1%;">
            <div class="row field_wrapper" id="field_wrapper">
              ...
              <table class="table">
                ...
                <tr>
                  ...
                  <td><select id="basic" class="selectpicker show-tick form-control" name="product_id[]" data-live-search="true">
                ...
                <?php if(isset($o_temp)): ?>
                <?php $__currentLoopData = $o_temp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td> <input type="date" name="product_expire_date[]" value="<?php $date=$row->p_expired_date;
                  ...
                  <td> <input type="text" name="total_amount[]" value="<?php echo e($row->p_price_per_item*$row->p_quantity); ?>" class="form-control form-control-sm" id="total" readonly="readonly" ></td>
                  <td>
                    <a href="<?php echo e(URL::to('order/edit/delete/'.$row->id.'/'.$row->o_id)); ?>" class="btn btn-danger btn-sm"><span class="lnr lnr-trash"></span></a>
                  </td>
            ...
            <input type="submit" name="saves" value="Save" class="btn btn-success btn-sm">
            </div>
...
<?php echo $__env->make("layouts.tables", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intime_delivery\resources\views/order/order_edit.blade.php ENDPATH**/ ?>