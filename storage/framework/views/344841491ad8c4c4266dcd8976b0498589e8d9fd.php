						...
						<div class="panel">
							...
							<div class="form-group">
									...
									<div class="col-lg-12">
										...
										<input type="hidden" name="post_id" id="post_id" value="<?php echo e($postman_id); ?>">
									...
									<table class="table"  style="font-size: 13px;" >
										...
										<tbody id="tbody">
											...
											<?php $__currentLoopData = $assign_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a_list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
											<tr>
												<td><?php echo $i++ ?></td>
												<td><?php echo e($a_list->p_id); ?></td>
												<td><?php echo e($a_list->product_name); ?></td>
												<td><?php echo e($a_list->product_type); ?></td>
												<td><?php echo e($a_list->product_size); ?></td>
												<td><?php echo e($a_list->product_vendor_name); ?></td>
												<td><?php echo e($a_list->qty); ?></td>
												<td><?php echo e($a_list->assign_date); ?></td>
											</tr>
											<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		...
		$(function () {
			$("#start_date,#end_date").on('change',function () {
				...
				$.ajax({
					...
					url : '<?php echo e(URL::to('/admin/date/route')); ?>',
...
<?php echo $__env->make("layouts.admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intime_delivery\resources\views/warehouse/stock/stock_outgoing.blade.php ENDPATH**/ ?>