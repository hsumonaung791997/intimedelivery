...
<div class="col-md-6">
            <div class="col-md-12">
              <div class="row">
                ...
                <input id="form_name" type="text" name="product_id" class="form-control" readonly value="<?php echo e($row->product_id); ?>" >
                <div class="help-block with-errors"></div>
              </div>
                </div>
                <div class="col-md-8">
              ...
              <div class="row">
                ...
                <?php if($od->o_id == $row->order_id): ?>
            <input type="hidden" name="o_id" value="<?php echo e($od->o_id); ?>">
                
                <div class="col-md-4">
                  <div class="form-group">
                <label for="form_name">Prouct ID</label>

                <input id="form_name" type="text" name="product_id" class="form-control" readonly value="<?php echo e($od->p_id); ?>" >
                <div class="help-block with-errors"></div>
              </div>
                </div>
                <div class="col-md-8">
              ...
              <div class="row">
                <div class="col-md-4">
                  <div class="form-group">
                <label for="form_name">Quantity</label>
                <input id="form_name" type="text" name="qty" class="form-control" value="<?php echo e($od->p_quantity); ?>" readonly>
                <div class="help-block with-errors"></div>
              </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
                <label for="form_name">Price Per Item</label>
                <input id="form_name" type="text" name="price_per_item" class="form-control" readonly value="<?php echo e($od->p_price_per_item); ?>">
                <div class="help-block with-errors"></div>
              </div>
                </div>  
                <div class="col-md-4">
                <div class="form-group">
                <label for="form_name">Sub Total </label>
                <input id="form_name" type="text" name="sub_total_amount" class="form-control" readonly value="<?php echo e($od->p_price_per_item*$od->p_quantity); ?>">
                <div class="help-block with-errors"></div>
              </div>
                </div>
                <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php $__currentLoopData = $orderTable; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if($ot->o_id == $row->order_id ): ?>
                <div class="col-md-4">
                <div class="form-group">
                <label for="form_name">Total Amount </label>
                <input id="form_name" type="text" name="total_amount" class="form-control" readonly value="<?php echo e($ot->o_amount_total); ?>">
                <div class="help-block with-errors"></div>
              </div>
                </div>
                ...
                <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <input type="hidden" name="s_name" value="<?php echo e($row->s_id); ?>">

                      <input id="form_name" type="text" class="form-control" readonly value="<?php echo e($row->s_name); ?>">
                      <div class="help-block with-errors"></div>
                    </div>  
                    </div>
                    <div class="col-md-6">
                      ...
                      <input type="hidden" name="t_name" value="<?php echo e($row->t_id); ?>">

                      <input id="form_name" type="text"  class="form-control" readonly value="<?php echo e($row->t_name); ?>">
                      <div class="help-block with-errors"></div>
                    </div>  
                    </div>
                  </div>
...
<?php echo $__env->make("layouts.admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intime_delivery\resources\views/admin/route/edit.blade.php ENDPATH**/ ?>