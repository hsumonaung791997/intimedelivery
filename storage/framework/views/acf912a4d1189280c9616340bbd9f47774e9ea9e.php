...
<div class="row">
			...
			<div class="col-md-12">
						...
						<form action="<?php echo e(URL::to('admin/stock/return/search')); ?>" method="get">
							<?php 
									...
									<div class="col-md-12 col-lg-12 col-sm-12">
						                    <div class="col-md-3 col-lg-3 col-sm-3">
							                    <input type="text" class="form-control" name="search" placeholder="Search Product ID,Name,Type,Size AND Postman Name" value="<?php echo e($name); ?>">
							                  </div>
							                  <div class="col-md-3 col-lg-3 col-sm-3">
									...
									<?php if(isset($result_data)): ?>
									 <?php echo e($result_data->appends(Request::except('/admin/stock/return/search'))->setPath('/admin/stock/return/search')); ?>


									<?php else: ?>
									 <?php echo e($result->appends(Request::except('/admin/stock/return'))->setPath('/admin/stock/return')); ?>
...
<?php echo $__env->make("layouts.admin", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\intime_delivery\resources\views/admin/stock/stock_return.blade.php ENDPATH**/ ?>