			...
			<div class="col-md-12">
							...
							<div class="panel">
								...
								<div class="panel-body">
									<div class="row">
										<form action="{{URL::to('warehouse/stock/list/search')}}" method="get">
										@csrf 
										<?php 
									...
									@if(isset($result_data))
									 {{ $result_data->appends(Request::except('/warehouse/stock/list/search'))->setPath('/warehouse/stock/list/search') }}

									@else
									 {{ $result->appends(Request::except('/warehouse/stock/list'))->setPath('/warehouse/stock/list') }}
									 @endif
								</div>
							</div>
							<!-- END BASIC TABLE -->
