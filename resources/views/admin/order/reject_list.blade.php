...
<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title">Order Reject Table</h3>
								</div>
								<div class="panel-body">
									<div class="row">
										<form action="{{URL::to('admin/order/reject/search')}}" method="get">
										@csrf 
												...
												<td>
   													<div class="dropdown">
  														...
  														<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
  															...
  															<div class="text-center"><a data-toggle="modal" data-target=".bd-example-modal-lg<?php echo $row->o_id; ?>" class="dropdown-item" id="click_link" >Preview</a></div>
    														<div class="text-center"><a class="dropdown-item" href="{{URL::to('admin/order/verify/'.$row->o_id)}}">Verify</a></div>
    														<div class="text-center"><a class="dropdown-item" href="{{URL::to('admin/order/reject/'.$row->o_id)}}">Reject</a></div>
   														</div>
													</div>   	
												</td>
									...
									@if(isset($result_data))
									 {{ $result_data->appends(Request::except('/admin/order/verified'))->setPath('/admin/order/verified') }}
