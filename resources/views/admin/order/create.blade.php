...
@section('content')
  <link rel="stylesheet" href="{{URL::to('bootstrap-select.css')}}">
     <div class="panel">
      <form action="{{URL::to('admin/order/store')}}" method="post">
        @csrf
            ...
            <div class="form-inline" style="margin-top: 1%;">
                ...
                <label>Vouchor No: </label>
                  <div class="form-group ">
                    ...
                    <div>
                        @if($errors->has('vouchor_no'))
                            <span class="alert text-danger">{{$errors->first('vouchor_no')}}</span>
                        @endif
                    </div>
                  </div>
                </div>
                    ...
                    <label for="form_name">Postman</label>
                        <select class="form-control" name="postman" id="postman">
                            <option>SELECT Postman</option>
                                @foreach($postmans as $postman)
                            <option value="{{$postman->id}}">{{$postman->user_name}}</option>
                                @endforeach
                        </select>
                        <div>
                         @if($errors->has('postman'))
                            <span class="alert text-danger">{{$errors->first('postman')}}</span>
                        @endif
                      </div>
                </div>
            </div><br><br>
                ...
                <div class="form-group">
                    <label for="form_name">Delivery Charges</label>
                        ...
                        @if($errors->has('delivery_charges'))
                            <span class="alert text-danger">{{$errors->first('delivery_charges')}}</span>
                        @endif
                      </div>
                </div>
            </div>
                ...
                <div class="form-group">
                   ...
                   <div>
                        @if($errors->has('extra_charges'))
                            <span class="alert text-danger">{{$errors->first('extra_charges')}}</span>
                        @endif
                    </div>
                </div>
            </div> 
                ...
                <div class="form-group">
                    ...
                    <div>
                        @if($errors->has('payment_status'))
                            <span class="alert text-danger">{{$errors->first('payment_status')}}</span>
                        @endif
                      </div>
                </div>
            </div><br><br>
              ...
              <table class="table">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <option value="{{$product->product_id}}">{{$product->p_id}}</option>    
                      @endforeach
                  </select>
                </td>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{URL::to('admin/order/delete/'.$row->id.'/'.$row->o_id)}}" class="btn btn-danger btn-sm"><span class="lnr lnr-trash"></span></a>
                  </td>
                </tr>
                @endforeach
                @endif
