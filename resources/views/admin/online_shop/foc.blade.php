...
<div class="col-md-12">
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    <form action="{{URL::to('admin/foc/search')}}" method="get">
                  ...
                  <div class="col-md-3 col-lg-3 col-sm-3">
                   ...
                   <input name="print" type="submit" class="btn btn-success" value="Print"> 
                                    ...
                                    <table class="table">
                                     ...
                                     @if(isset($result_data))
                  {{ $result_data->appends(Request::except('/admin/foc/search'))->setPath('/admin/foc/search') }}
                  @else
                  {{ $result->appends(Request::except('/admin/foc/list'))->setPath('/admin/foc/list') }}
                  @endif
                                </div>
                            </div>
                            <!-- END BASIC TABLE -->
