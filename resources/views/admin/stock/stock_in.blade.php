...
<div class="row">
			...
			<div class="col-md-12">
						...
						<form action="{{URL::to('admin/stock/incoming/search')}}" method="get">
							@csrf
							<?php 
									...
									{{ $result_data->appends(Request::except('/admin/stock/incoming/search'))->setPath('/admin/stock/incoming/search') }}
									@else
									{{ $result->appends(Request::except('/admin/stock/in'))->setPath('/admin/stock/in') }}
									@endif
								</div>
							</div>
							<!-- END BASIC TABLE -->
