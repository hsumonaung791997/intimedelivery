...
<div class="row">
			...
			<div class="col-md-12">
						...
						<form action="{{URL::to('admin/stock/outgoing/search')}}" method="get">
							<?php 
									...
									{{ $result_data->appends(Request::except('admin/stock/outgoing/search'))->setPath('admin/stock/outgoing/search') }}
									@else
									{{ $result->appends(Request::except('/admin/stock/out'))->setPath('/admin/stock/out') }}
									@endif
								</div>
							</div>
							<!-- END BASIC TABLE -->
