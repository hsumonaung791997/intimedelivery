...
<div class="row">
			...
			<div class="col-md-12">
						...
						<form action="{{URL::to('admin/stock/return/search')}}" method="get">
							<?php 
									...
									@if(isset($result_data))
									 {{ $result_data->appends(Request::except('/admin/stock/return/search'))->setPath('/admin/stock/return/search') }}

									@else
									 {{ $result->appends(Request::except('/admin/stock/return'))->setPath('/admin/stock/return') }}
									 @endif
								</div>
							</div>
							<!-- END BASIC TABLE -->
