			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li><a href="{{URL::to('parcel/create/')}}" class=""><i class="lnr lnr-gift"></i> <span>Product Register</span> </a></li>
						
						<li><a href="{{URL::to('route/plan/')}}" class=""><i class="lnr lnr-map-marker"></i> <span>Route Entry</span> </a></li>
						<li><a href="{{URL::to('route/list')}}" class=""><i class="lnr lnr-map"></i> <span>Route List</span> </a></li>
						<li><a href="{{URL::to('multi/route/plan')}}" class=""><i class="lnr lnr-map"></i> <span>Multi Route List</span> </a></li>
						
						<li><a href="{{URL::to('order/list')}}" class=""><span class="lnr lnr-list"></span>Order List</span> </a></li>
